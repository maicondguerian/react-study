...
import ModalOverlay from "../ModalOverlay/ModalOverley";
    ...
    return(
        ...
        <div className={Styles.mainMenu}>
          ...
          <div  className={Styles.inputBar}>
            <input type="text" className={Styles.inputSearchBar} name="Search-bar" value="" placeholder='busque aqui seu produto'/> <FiSearch className={Styles.IconSearch} onClick={false} />
          </div>
