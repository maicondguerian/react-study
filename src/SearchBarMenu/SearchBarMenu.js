...
const SearchBar =({ Icon, iconSize=20, fontSize=16 })=>{
    return(
        <>
        ...
        <div  className={Styles.inputBar}>
         <input type="text" className={Styles.inputSearchBar} name="Search-bar" value="" placeholder='busque aqui seu produto'/> <FiSearch className={Styles.IconSearch} onClick={true} />
        </div>
