...
export default function MenuLinks() {
    ...
    return (
        <>
            <main className={Styles.containerLinks}>
                
                <span className={Styles.cepButton} > {/*onMouseOver={onMouseOver} onMouseLeave={handleMouseOut}> */}
